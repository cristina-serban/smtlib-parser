...
#ifndef SMTLIB_PARSER_CONFIGURATION_H
#define SMTLIB_PARSER_CONFIGURATION_H
    ...
    private:
        ...
        static inline std::string &rtrim(std::string &s) {
            s.erase(std::find_if(s.rbegin(), s.rend(),
                                 std::not1(std::ptr_fun<char, bool>(Configuration::isTrimChar))).base(), s.end());
            return s;
        }
...
#endif //SMTLIB_PARSER_CONFIGURATION_H