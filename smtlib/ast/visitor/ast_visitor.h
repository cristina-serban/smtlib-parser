/**
 * \file ast_visitor.h
 * \brief Visitor for the SMT-LIB AST.
 * \author Cristina Serban <cristina.serban89@gmail.com>
 */

#ifndef SMTLIB_PARSER_AST_VISITOR_H
#define SMTLIB_PARSER_AST_VISITOR_H
...
namespace smtlib {
    namespace ast {
        class AstVisitor0 {
        protected:
            virtual void visit0(sptr_t<AstNode> node);
            template<class T>
        ...
        public:
            ...
            virtual void visit(sptr_t<VarBinding> node) = 0;
        };

        class DummyAstVisitor0 : public virtual AstVisitor0 {
        public:
...
#endif //SMTLIB_PARSER_AST_VISITOR_H